...
class FeatureSpace(object):
    ...
    def FeatureEng(self):
        ...
        print("featureEngX",featureEngX)
        print("featureEngY", featureEngY)
    ...
    def TrainTestValidateXY(self):
        ...
        print("self.trainImageX",self.trainImageX)
        print("self.trainImageY", self.trainImageY)
        # - test
        self.testImageX = ImageX[testIndex, :, :, :]
        self.testImageY = ImageY[testIndex, :]
        print("self.testImageX",self.testImageX)
        print("self.testImageY", self.testImageY)
        # - validate
