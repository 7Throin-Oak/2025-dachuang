...
class myModel(object):
	...
	def __init__(self , model ,  dataFileName , dataFilePath  , winWidth = 100 , slidingLen = 10 , featureList = ['MAV', 'RMS'] , trainPercent = [0.7, 0.3, 0]):
...
if __name__ == "__main__":
	...
	# mModel = myModel(RandomForestClassifier(), 'lhx2',
	# 				 'data/emgData/' + 'lhx2' + '.csv', featureList=['MAV', 'RMS', "ZC"])
	mModel = myModel(RandomForestClassifier(), '3',
					 'data/emgData/' + '3' + '.csv', featureList=['MAV', 'RMS'])
