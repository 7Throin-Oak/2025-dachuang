...
import numpy as np
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "D:\大学期间活动及竞赛资料\2024大创资料\Real_Env-master\robot\doosan\doosan_api\api_types.py")))
...
if __name__ == "__main__":
    ...
    while time.time()-u<=20:
        ...
        ee = np.concatenate([MO_XYZ, y_zitai])
        print("ee", ee)
